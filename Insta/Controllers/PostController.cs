...
namespace Insta.Controllers
{
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,PhotoUrl,Caption")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,PhotoUrl,Caption")] Post post)
        {
            if (id != post.ID)
            {
                return NotFound();
